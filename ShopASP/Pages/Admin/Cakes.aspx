<%@ Page Title="" Language="C#" 
    ...
    CodeBehind="Cakes.aspx.cs" 
    Inherits="ShopASP.Pages.Admin.Cakes" %>


<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ListView ID="ListView1" ItemType="ShopASP.Models.Cake" 
        SelectMethod="GetCakes"
        DataKeyNames="CakeId" 
        UpdateMethod="UpdateCake" 
        DeleteMethod="DeleteCake"
        InsertMethod="InsertCake" 
        ...
        <EditItemTemplate>
            <tr>
                <td>
                    ...
                    <input type="hidden" name="ProductID" value="<%# Item.CakeId %>" />
                </td>
                <td>
                ...
                <td>
                    <input name="quantity" value="<%# Item.Quantity %>" /></td>
                <td>
